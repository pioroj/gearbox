...
class ComfortGearCalculatorTest {
    ...
    void shouldShiftUpWhenAboveMaxRpm() {
        Gear nextGear = comfortGearCalculator.calculateGear(
                new CalculatorInputData(RPM.rpm(3200), Gear.of(6), new GasThreshold(0.3d), AggressiveMode.MEDIUM, 150, false, false));
    ...
    void shouldShiftDownWhenBelowMinRpm() {
        Gear nextGear = comfortGearCalculator.calculateGear(
                new CalculatorInputData(RPM.rpm(800), Gear.of(6), new GasThreshold(0.3d), AggressiveMode.MEDIUM, 150, false, false));
    ...
    void shouldDoNothingWhenWithinOptimalRpm() {
        Gear nextGear = comfortGearCalculator.calculateGear(
                new CalculatorInputData(RPM.rpm(2200), Gear.of(6), new GasThreshold(0.3d), AggressiveMode.MEDIUM, 150, false, false));
    ...
    void shouldDoNothingWhenMaxGearReached() {
        Gear nextGear = comfortGearCalculator.calculateGear(
                new CalculatorInputData(RPM.rpm(3200), Gear.of(8), new GasThreshold(0.3d), AggressiveMode.MEDIUM, 150, false, false));
    ...
    void shouldDoNothingWhenMinGearReached() {
        Gear nextGear = comfortGearCalculator.calculateGear(
                new CalculatorInputData(RPM.rpm(1200), Gear.of(1), new GasThreshold(0.3d), AggressiveMode.MEDIUM, 150, false, false));
    ...
    void shouldShiftUpInBasicAggresiveMode() {
        Gear nextGear = comfortGearCalculator.calculateGear(
                new CalculatorInputData(RPM.rpm(2600), Gear.of(4), new GasThreshold(0.3d), AggressiveMode.BASIC, 150, false, false));
