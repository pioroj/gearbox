...
class EcoGearCalculatorTest {
    ...
    private EcoGearCalculator ecoGearCalculator = new EcoGearCalculator(new RpmRange(RPM.k(2), RPM.k(3)), new GearRange(Gear.of(1), Gear.of(8)), GasThresholdRange.noKickdownRange());

    @Test
    void shouldShiftUpWhenAboveMaxRpm() {
        Gear nextGear = ecoGearCalculator.calculateGear(RPM.rpm(3200), Gear.of(6), new GasThreshold(0.3d));
    ...
    void shouldShiftDownWhenBelowMinRpm() {
        Gear nextGear = ecoGearCalculator.calculateGear(RPM.rpm(1200), Gear.of(6), new GasThreshold(0.3d));
    ...
    void shouldDoNothingWhenWithinOptimalRpm() {
        Gear nextGear = ecoGearCalculator.calculateGear(RPM.rpm(2200), Gear.of(6), new GasThreshold(0.3d));
    ...
    void shouldDoNothingWhenMaxGearReached() {
        Gear nextGear = ecoGearCalculator.calculateGear(RPM.rpm(3200), Gear.of(8), new GasThreshold(0.3d));
    ...
    void shouldDoNothingWhenMinGearReached() {
        Gear nextGear = ecoGearCalculator.calculateGear(RPM.rpm(1200), Gear.of(1), new GasThreshold(0.3d));
